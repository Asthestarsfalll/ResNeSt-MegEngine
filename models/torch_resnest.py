...
class SplAtConv2d(Module):
    ...
    def __init__(self, in_channels, channels, kernel_size, stride=(1, 1), padding=(0, 0),
                 ...
                 rectify=False, rectify_avg=False, norm_layer=BatchNorm2d,
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 ...
                 norm_layer=BatchNorm2d, dropblock_prob=0.0, last_gamma=False):
...
if __name__ == '__main__':
    import numpy as np
    model = resnest50()
    inp = torch.tensor(np.random.rand(2, 3, 224, 224),dtype=torch.float32)
    out = model(inp)
    print(out.shape) 
